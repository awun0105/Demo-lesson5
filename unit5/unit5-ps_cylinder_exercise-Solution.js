...
* @param top
 @param bottom - THREE.Vector3, top and bottom positions of cone
...
*/
function createCylinderFromEnds( material, radiusTop, radiusBottom, top, bottom, segmentsWidth, openEnded, stretchFactor)
{

	// Dummy settings, replace with proper code:
	//Get cyclinder height
	var length = cylAxis
	var cylAxis = new THREE.Vector3();
	cylAxis.subVectors(top,bottom);
	//Get cyclinder center for translation
